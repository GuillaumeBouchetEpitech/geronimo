...
#include "TrianglesAccumulator.hpp"
...
// void TrianglesAccumulator::initialize(gero::graphics::opengl::IUnboundShaderProgram& shader,
...
void TrianglesAccumulator::pushTriangle(const glm::vec3& posA,
                                          const glm::vec3& posB,
                                          const glm::vec3& posC,
  ...
  const glm::vec3 diff1 = posB - posA;
  const glm::vec3 diff2 = posC - posA;
  const glm::vec3 normal = glm::cross(diff2, diff1);

  _vertices.emplace_back(posA, normal, colorA);
  _vertices.emplace_back(posB, normal, colorB);
  _vertices.emplace_back(posC, normal, colorC);
}
...
// void TrianglesAccumulator::pushThickTriangle2dLine(const glm::vec2& posA,
//                                                      const glm::vec2& posB,
//                                                      float thicknessA,
//                                                      float thicknessB,
//                                                      const glm::vec3& colorA,
...
// // void TrianglesAccumulator::pushQuad(const glm::vec2& center, const glm::vec2& size, const glm::vec4& color, float z) {
...
// // void TrianglesAccumulator::pushQuad(const glm::vec2& center, const glm::vec2& size, const glm::vec4& color) {
// //   pushQuad(center, size, color, 0.0f);
// // }

// // void TrianglesAccumulator::pushCircle(const glm::vec2& center, float radius, const glm::vec4& color, float z) {
...
// // void TrianglesAccumulator::pushCircle(const glm::vec2& center, float radius, const glm::vec4& color) {
...
// void TrianglesAccumulator::pushThickTriangle2dLine(
//   const glm::vec2& posA, const glm::vec2& posB, float thickness, const glm::vec3& color, float z) {
...
void TrianglesAccumulator::pushThickTriangle3dLine(const glm::vec3& posA,
                                                     const glm::vec3& posB,
                                                     float thicknessA,
                                                     float thicknessB,
                                                     const glm::vec3& colorA,
...
// void TrianglesAccumulator::pushThickTriangle3dCross(
...
// void TrianglesAccumulator::flush() {
//   if (!canRender())
//     return;
...
// bool TrianglesAccumulator::canRender() const { return !_vertices.empty(); }

// void TrianglesAccumulator::startSafeMode() { _safeMode = true; }

// void TrianglesAccumulator::stopSafeMode() { _safeMode = false; }
