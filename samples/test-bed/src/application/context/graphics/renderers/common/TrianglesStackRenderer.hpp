...
public:
  void initialize(ShaderAliases shaderId, GeometryIds geometryId);
...
public:
  void pushQuad(const glm::vec2& center, const glm::vec2& size, const glm::vec4& color, float z);
  void pushQuad(const glm::vec2& center, const glm::vec2& size, const glm::vec4& color);

public:
  void pushCircle(const glm::vec2& center, float radius, const glm::vec4& color, float z);
...
public:
  ...
  void pushThickTriangle2dLine(const glm::vec2& posA, const glm::vec2& posB, float thickness, const glm::vec4& color);
...
public:
  void pushThickTriangle3dLine(const glm::vec3& posA,
                               ...
                               const glm::vec4& colorA,
                               const glm::vec4& colorB);
  void pushThickTriangle3dLine(const glm::vec3& posA, const glm::vec3& posB, float thickness, const glm::vec4& color);
