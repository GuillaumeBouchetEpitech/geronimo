    ...
    if (averageDuration < 999 || minFDuration < 999 || maxFDuration < 999) {
      ...
      { // text
        ...
        inTextRenderer.setOutlineColor(glm::vec4(0, 0, 0, 1))
          ...
          .setDepth(inPos.z)
          .setHorizontalTextAlign(opengl::advanced::TextRenderer::HorizontalTextAlign::left);
        ...
        if (averageDuration < 999) {
          ...
          inTextRenderer.setMainColor(glm::vec4(1.0f, 1.0f, 0.75f, 1.0f))
            .setVerticalTextAlign(opengl::advanced::TextRenderer::VerticalTextAlign::top);
        ...
        if (maxFDuration < 999) {
          ...
          inTextRenderer
            ...
            .setVerticalTextAlign(opengl::advanced::TextRenderer::VerticalTextAlign::center);
