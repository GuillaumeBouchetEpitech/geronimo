...
void TextRenderer::initialize(const std::string& inRootPath) {
  ...
  _graphic.shader = std::make_shared<gero::graphics::opengl::ShaderProgram>(shaderProgramBuilder.getDefinition());

  gero::graphics::Image tmpImg;
  tmpImg.loadFromFile(inRootPath + "/textures/ascii_font.png");

  _graphic.texture = std::make_shared<gero::graphics::opengl::Texture>();
  _graphic.texture->setFromImage(
    tmpImg, gero::graphics::opengl::Texture::Quality::pixelated, gero::graphics::opengl::Texture::Pattern::clamped);
...

  {
    ...
    geometryBuilder.reset()
      ...
      .addVbo()
      .addVboAttribute("a_position", gero::graphics::opengl::Geometry::AttrType::Vec2f)
      .addVboAttribute("a_texCoord", gero::graphics::opengl::Geometry::AttrType::Vec2f)
      .addVbo()
      .setVboAsInstanced()
      .addVboAttribute("a_offsetPosition", gero::graphics::opengl::Geometry::AttrType::Vec3f)
      .addVboAttribute("a_offsetTexCoord", gero::graphics::opengl::Geometry::AttrType::Vec2f)
      .addVboAttribute("a_offsetColor", gero::graphics::opengl::Geometry::AttrType::Vec4f)
      .addVboAttribute("a_offsetScale", gero::graphics::opengl::Geometry::AttrType::Float);
...
ITextRenderer& TextRenderer::setMatricesData(const gero::graphics::camera::ICamera::MatricesData& matricesData) {
...
ITextRenderer& TextRenderer::render() {
  ...
  _graphic.shader->preBind([this](gero::graphics::opengl::IBoundShaderProgram& bound) {
    ...
    _graphic.geometry.allocateBuffer(1, _graphic.vertices);
