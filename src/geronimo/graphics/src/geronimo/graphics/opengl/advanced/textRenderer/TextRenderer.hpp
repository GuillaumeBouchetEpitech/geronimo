...
public:
  virtual ITextRenderer& setMatricesData(const gero::graphics::camera::ICamera::MatricesData& matricesData) = 0;
...
private:
  struct Graphic {
    ...
    std::shared_ptr<gero::graphics::opengl::ShaderProgram> shader;
    std::shared_ptr<gero::graphics::opengl::Texture> texture;
    gero::graphics::opengl::Geometry geometry;
    gero::graphics::camera::ICamera::MatricesData matricesData;
  } _graphic;
...
public:
  ITextRenderer& setMatricesData(const gero::graphics::camera::ICamera::MatricesData& matricesData) override;
