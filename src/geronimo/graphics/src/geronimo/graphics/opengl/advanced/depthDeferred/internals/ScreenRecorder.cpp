...
const gero::graphics::opengl::Texture& ScreenRecorder::getColorTexture() const { return _colorTexture; }

const gero::graphics::opengl::Texture& ScreenRecorder::getPositionTexture() const { return _positionTexture; }

const gero::graphics::opengl::Texture& ScreenRecorder::getNormalTexture() const { return _normalTexture; }

const gero::graphics::opengl::Texture& ScreenRecorder::getDepthTexture() const { return _depthTexture; }
