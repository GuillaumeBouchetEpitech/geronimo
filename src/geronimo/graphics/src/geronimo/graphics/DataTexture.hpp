...
public:
  ...
  void update(const glm::vec4* inDataPointer,
...
public:
  ...
  void update(const float* inDataPointer,
              uint32_t inDataLength,
              const glm::uvec2& inOriginSize,
              const glm::uvec2& inUpdateSize);
...
public:
  ...
  void update(const int16_t* inDataPointer,
              uint32_t inDataLength,
              const glm::uvec2& inOriginSize,
              const glm::uvec2& inUpdateSize);
...
public:
  ...
  void update(const int32_t* inDataPointer,
              uint32_t inDataLength,
              const glm::uvec2& inOriginSize,
              const glm::uvec2& inUpdateSize);
