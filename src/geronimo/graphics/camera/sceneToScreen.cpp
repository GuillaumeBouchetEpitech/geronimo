...
bool sceneToScreen(const glm::vec3& sceneTarget,
  ...
  // Modelview transform
  glm::vec4 vec4A;
  vec4A.x = modM[0] * sceneTarget.x + modM[4] * sceneTarget.y + modM[8] * sceneTarget.z + modM[12]; // w is always 1
  vec4A.y = modM[1] * sceneTarget.x + modM[5] * sceneTarget.y + modM[9] * sceneTarget.z + modM[13];
  vec4A.z = modM[2] * sceneTarget.x + modM[6] * sceneTarget.y + modM[10] * sceneTarget.z + modM[14];
  vec4A.w = modM[3] * sceneTarget.x + modM[7] * sceneTarget.y + modM[11] * sceneTarget.z + modM[15];
