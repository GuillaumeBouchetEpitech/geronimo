...
btjsCollisionAlgorithm::CreateFunc::CreateCollisionAlgorithm(btCollisionAlgorithmConstructionInfo& ci,
...
btjsCollisionAlgorithm::btjsCollisionAlgorithm(const btCollisionAlgorithmConstructionInfo& ci,
...
void btjsCollisionAlgorithm::processCollision(const btCollisionObjectWrapper* pBody0Wrap,
                                              const btCollisionObjectWrapper* pBody1Wrap,
