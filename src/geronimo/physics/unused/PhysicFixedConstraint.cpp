...
PhysicFixedConstraint::PhysicFixedConstraint(const PhysicFixedConstraintDef& def) {
  ...
  _bullet.constraint = new btFixedConstraint(*def.body_a->_bullet.body, *def.body_b->_bullet.body, frameInA, frameInB);
