...
void PhysicConeTwistConstraint::setLinearLowerLimit(const glm::vec3& linearLower)
{
  _bullet.constraint->setLinearLowerLimit(btVector3(linearLower.x, linearLower.y, linearLower.z));
}

void PhysicConeTwistConstraint::setLinearUpperLimit(const glm::vec3& linearUpper)
{
  _bullet.constraint->setLinearUpperLimit(btVector3(linearUpper.x, linearUpper.y, linearUpper.z));
}

glm::vec3 PhysicConeTwistConstraint::getLinearLowerLimit() const
{
  btVector3 value;
...
glm::vec3 PhysicConeTwistConstraint::getLinearUpperLimit() const
{
  btVector3 value;
...
void PhysicConeTwistConstraint::setAngularLowerLimit(const glm::vec3& angularLower)
{
  _bullet.constraint->setAngularLowerLimit(btVector3(angularLower.x, angularLower.y, angularLower.z));
}

void PhysicConeTwistConstraint::setAngularUpperLimit(const glm::vec3& angularUpper)
{
  _bullet.constraint->setAngularUpperLimit(btVector3(angularUpper.x, angularUpper.y, angularUpper.z));
}

glm::vec3 PhysicConeTwistConstraint::getAngularLowerLimit() const
{
  btVector3 value;
...
glm::vec3 PhysicConeTwistConstraint::getAngularUpperLimit() const
{
  btVector3 value;
...
// glm::vec3 PhysicConeTwistConstraint::getAnchor1() const
// {
//   const btVector3& value = _bullet.constraint->getAnchor();
//   return glm::vec3(value[0], value[1], value[2]);
// }
// glm::vec3 PhysicConeTwistConstraint::getAnchor2() const
// {
//   const btVector3& value = _bullet.constraint->getAnchor2();
//   return glm::vec3(value[0], value[1], value[2]);
// }
// glm::vec3 PhysicConeTwistConstraint::getAxis1() const
// {
//   const btVector3& value = _bullet.constraint->getAxis1();
//   return glm::vec3(value[0], value[1], value[2]);
// }
// glm::vec3 PhysicConeTwistConstraint::getAxis2() const
// {
//   const btVector3& value = _bullet.constraint->getAxis2();
//   return glm::vec3(value[0], value[1], value[2]);
// }
// float PhysicConeTwistConstraint::getAngle1() const
// {
//   return _bullet.constraint->getAngle1();
// }
// float PhysicConeTwistConstraint::getAngle2() const
// {
//   return _bullet.constraint->getAngle2();
// }
// void PhysicConeTwistConstraint::setUpperLimit(float angle1Max, float angle2Max)
// {
//   _bullet.constraint->setUpperLimit(angle1Max, angle2Max);
// }
// void PhysicConeTwistConstraint::setLowerLimit(float angle1Min, float angle2Min)
// {
