...
PhysicUniversalConstraint::PhysicUniversalConstraint(const PhysicUniversalConstraintDef& def) {
  ...
  _bullet.constraint = new btUniversalConstraint(
...
PhysicUniversalConstraint::~PhysicUniversalConstraint() {
...
float PhysicUniversalConstraint::getAngle1() const
{
  return _bullet.constraint->getAngle1();
}
float PhysicUniversalConstraint::getAngle2() const
{
