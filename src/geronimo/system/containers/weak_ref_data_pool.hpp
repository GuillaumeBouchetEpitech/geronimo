...
public:
  ...
  public:
    ...
    virtual ~weak_ref() {
      ...
      // D_MYERR(" => this " <<  this << ",  _pool " << _pool << ", _index " <<
      // _index);
      if (_pool) {
  ...
  public:
    ...
    bool operator!=(const weak_ref& other) const {
      return !weak_ref::operator==(other);
    }
...
public:
  ...
  uint32_t get_ref_count(const weak_ref& ref) {
