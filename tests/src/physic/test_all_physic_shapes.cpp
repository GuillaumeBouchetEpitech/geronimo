...
TEST(physic_wrapper, test_all_shapes) {
...

  {
    ...
    {
      gero::physics::PhysicBodyDef bodyDef;
      bodyDef.shape.type = gero::physics::PhysicShapeDef::Type::box;
    ...
    {
      gero::physics::PhysicBodyDef bodyDef;
      bodyDef.shape.type = gero::physics::PhysicShapeDef::Type::capsule;
...

    {
      ...
      bodyDef.shape.type = gero::physics::PhysicShapeDef::Type::staticMesh;
...

    {
      ...
      {
        auto shapeDef = std::make_shared<gero::physics::PhysicShapeDef>();
        shapeDef->type = gero::physics::PhysicShapeDef::Type::compound;
        {
