...
TEST(system_collisions, collisionRectRect) {
  ...
  {
    ASSERT_EQ(gero::math::collisionRectRect(glm::vec2(10,10),glm::vec2(20,10), glm::vec2(15,15),glm::vec2(20,10)), true);
  }

  {
    // bellow
    ASSERT_EQ(gero::math::collisionRectRect(glm::vec2(10,10),glm::vec2(20,10), glm::vec2(5,5),glm::vec2(6,3)), false);
    // above
    ASSERT_EQ(gero::math::collisionRectRect(glm::vec2(10,10),glm::vec2(20,10), glm::vec2(15,25),glm::vec2(6,3)), false);
    // left
    ASSERT_EQ(gero::math::collisionRectRect(glm::vec2(10,10),glm::vec2(20,10), glm::vec2(0,15),glm::vec2(6,3)), false);
    // right
    ASSERT_EQ(gero::math::collisionRectRect(glm::vec2(10,10),glm::vec2(20,10), glm::vec2(35,15),glm::vec2(6,3)), false);
  }
}
